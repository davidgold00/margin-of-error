...
_SHARED_COLUMNS: dict[str, Column] = {
    ...
    "TotalBsmtSF": Column(None, Check.greater_than_or_equal_to(0), nullable=True),
    ...
    "GarageCars": Column(None, Check.greater_than_or_equal_to(0), nullable=True),
    "GarageArea": Column(None, Check.greater_than_or_equal_to(0), nullable=True),
